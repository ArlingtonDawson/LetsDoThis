...
{
    [BurstCompile]
    public struct MoveableComponentGhostComponentSerializer
    {
        static GhostComponentSerializer.State GetState()
        {
            ...
            if (!s_StateInitialized)
            {
                s_State = new GhostComponentSerializer.State
                {
                    ...
                    ComponentType = ComponentType.ReadWrite<MoveableComponent>(),
                    ComponentSize = UnsafeUtility.SizeOf<MoveableComponent>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<MoveableComponent>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<MoveableComponent>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<MoveableComponent>(backupData, 0);
